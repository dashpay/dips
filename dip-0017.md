...
* **Feature index 17':** The next available [DIP-9](dip-0009.md) feature after 16' (DashPay Auto Accept Proof)) is reserved for Platform payments, avoiding collisions with existing features.
