...
The SignID is defined as _SignID = SHA256(quorumHash, requestID, msgHash)_ where msgHash is the hash of the entire transaction with the quorumSig field set to zeros. The transaction must be hashed as described in [DIP-2](./dip-0002.md#serialization-hashing-and-signing).
