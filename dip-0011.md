...
usernames. At a stark difference from DIP0005, Identities are decoupled from
...
Dash Platform Name Service (DPNS) is then used to retrieve Identities by names.
