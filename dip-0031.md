...
A node should accept and validate all of the information as
described in the [Validation section](#validation) via a new RPC command. Then, a node shall bundle this information into
